...
DROP FUNCTION IF EXISTS core.authorize_student_access(uuid, text, text, text, text, uuid) CASCADE;
DROP FUNCTION IF EXISTS core.can_access_subject_record(text, uuid, uuid, text, text, text) CASCADE;
DROP FUNCTION IF EXISTS core.has_active_consent(uuid, text, uuid, text, text, text) CASCADE;
