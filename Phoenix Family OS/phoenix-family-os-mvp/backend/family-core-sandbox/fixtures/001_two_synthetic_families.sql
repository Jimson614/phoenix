...
INSERT INTO entitlement.service_entitlements (
  ...
  (
    ...
    '10000000-0000-4000-8000-000000000002',
    '12000000-0000-4000-8000-000000000002',
    'ASKWISE', 'ACTIVE', '2026-09-09T00:00:00Z', '2027-09-09T00:00:00Z'
  ),
  (
...
INSERT INTO core.external_identity_mappings (
  ...
  (
    '52000000-0000-4000-8000-000000000001', 'STUDENT',
    'stu_00000000000040008000000000000001', 'ASKWISE_SQLITE',
    '101', 'SYNTHETIC_SOURCE_V1', 'ACTIVE',
    'OPERATOR_REVIEW', 'usr_00000000000040008000000000000001',
    '2026-09-09T00:00:00Z', '{"fixture":"SYNTHETIC_ONLY","source_id_type":"INTEGER"}'
  ),
  (
    '52000000-0000-4000-8000-000000000002', 'STUDENT',
    'stu_00000000000040008000000000000002', 'ASKWISE_SQLITE',
    '202', 'SYNTHETIC_SOURCE_V1', 'ACTIVE',
    'OPERATOR_REVIEW', 'usr_00000000000040008000000000000002',
    '2026-09-09T00:00:00Z', '{"fixture":"SYNTHETIC_ONLY","source_id_type":"INTEGER"}'
  );
